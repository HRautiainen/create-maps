...
### Set directory from github -----
# setwd("~/.../create-maps-main")
...
# maps_files_read <- maps_files_read[!grepl("ignore", maps_files_read)]
...
elevation <- maps[["PV_2021_dem"]]
sf::st_crs(elevation)$proj4string #known CRS, no transformation 
...
```{r echo=F}
#png("output_data/Fig3_GPS_data_hillshade.png", width = 30, height = 19, units = "cm", res = 400)
par(mfrow=c(2,2), mar=c(0.1, 0.1, 3, 0.1))
